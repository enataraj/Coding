...
public class LC1155NumberOfDiceRolls {
    ...
    */
    ...
    public int numRollsToTargetRecursion(int d, int f, int target) {
    ...
    public int numRollsToTargetMemo(int d, int f, int target) {
    ...
    public static void main(String[] args) {
        LC1155NumberOfDiceRolls obj = new LC1155NumberOfDiceRolls();
    }
