...
public class LC1984MinDiff {
    ...
    public static void main(String[] args) {
        int[] nums = { 41900, 69441, 94407, 37498, 20299, 10856, 36221, 2231, 54526, 79072, 84309, 76765, 92282, 13401,
        ...
        /*  int k = 1;
        int[] nums = { 90 };*/
        LC1984MinDiff obj = new LC1984MinDiff();
